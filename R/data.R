...
#' Tay and Ha Noi. Note also that we consider the TB hospital separately. Note
#' that the columns 4 to 11 are exclusive, meaning that one case cannot below to
#' different columns at the same time. The tree below illustrate the structure
#' of the data:
#'
#' \figure{tree.png}{}
#'
...
#' \itemize{
#'    \item \code{province}: province name (or hospital)
